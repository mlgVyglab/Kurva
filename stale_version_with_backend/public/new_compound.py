...
#json_data = '{ "compound" : { "smiles": "COc1cc(N=Nc2c(Cl)cc([N+](=O)[O-])cc2[N+](=O)[O-])c(NC(C)=O)cc1N(CCOC(C)=O)Cc1ccccc1", "dataset": "P-glycoprotein" }}'
...
#    received_smiles = 'COc1cc(N=Nc2c(Cl)cc([N+](=O)[O-])cc2[N+](=O)[O-])c(NC(C)=O)cc1N(CCOC(C)=O)Cc1ccccc1'
#    print(received_smiles)
